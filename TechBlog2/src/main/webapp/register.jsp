...
<%@include file="navbar.jsp" %> 
 ...
 <!-- <div class="d-flex align-items-center" style="height:91vh"> -->
   <div  id="main_container" class="container-fluid  banner primary-background">
      ...
      <div class="card-body ">
        <form  id="form"   >
         <div class="mb-3">
            ...
            <input type="text" name="user_name" class="form-control" id="user" aria-describedby="emailHelp"  required> 
          ...
          <div class="mb-3">
            ...
            <input type="email" name="user_email" class="form-control" id="email" aria-describedby="emailHelp"  required>
            <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
          </div>
          <div class="mb-3">
    ...
    female
        ...
        <textarea class="form-control" id="about"  name="about" rows="3" placeholder="Describe yourself here..." style="resize:none"></textarea>
          ...
          <div  class="container text-center">
            <span    id="refresh"   style="display:none"  class="fa fa-refresh  fa-spin fa-4x" ></span>
          </div>
        <br>
